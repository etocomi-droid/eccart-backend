...
exports.adminTranslationsRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [(0, framework_1.validateAndTransformQuery)(validators_1.AdminTranslationStatistics, {})],
    },
    {
        method: ["GET"],
        matcher: "/admin/translations/settings",
        middlewares: [
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminTranslationSettingsParams, {}),
        ],
    },
];
